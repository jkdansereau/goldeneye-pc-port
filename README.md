...
<p align="center">
  <video src="https://github.com/jkdansereau/goldeneye-pc-port/raw/main/docs/media/goldeneye-demo.mp4" width="640" controls muted loop>
    <a href="https://github.com/jkdansereau/goldeneye-pc-port/raw/main/docs/media/goldeneye-demo.mp4">Watch the demo clip (~15&nbsp;s, MP4)</a>
  </video>
  <br><em>~15&nbsp;s from the port, no audio yet (Phase&nbsp;3): mission dossier &rarr; Facility &rarr; Silo &rarr; Jungle &rarr; Archives.</em>
</p>

<p align="center">
  <img src="docs/img/attract-bunker1.png" width="32%" alt="Bunker 1 intro camera">
  <img src="docs/img/attract-silo.png" width="32%" alt="Silo intro camera">
  <img src="docs/img/attract-dam.png" width="32%" alt="Dam intro camera">
  <br><em>In-engine captures — Bunker&nbsp;1, Silo, and Dam attract-mode views running in the port.</em>
</p>
