...
description: Landing page for the GoldenEye 007 PC port — what it is, current status, and links to the build guide and engineering documentation.
---
...
codebase: two coding agents (a local open-weight model, Qwen 3.8, on a single
RTX 5090, and Claude / Claude Code), driven by one person part-time through
~230 translation units of unmodified big-endian MIPS game code, handing work
back and forth through shared written notes.
