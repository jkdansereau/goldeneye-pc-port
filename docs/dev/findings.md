...
sustained fire sound.** Per-symptom accounting: (1) "Klobb sound on melee" —
idx 106 is NEVER requested in the capture; the user heard the 109 barrage
(gun-bolt SFX) during his melee combat. (2) "explosion → scream" — explosion
...
4. After root-cause + fix: user re-test of melee / explosion / armor pickup
   vs N64 — expect all three "wrong sounds" to disappear with the barrage.
